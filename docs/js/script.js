        ...
        if (requestForm) {
            requestForm.addEventListener('submit', function(event) {
                ...
                const wsData = [
                    ...
                    [],
                    ['ATTREZZATURA', 'QUANTITÀ', 'CODICE NAV', 'mag.Marrubiu', 'mag.Mairano', 'Altro', 'Differenza']
                ];
            
                document.querySelectorAll('.attrezzatura-row').forEach((row, index) => {
                    ...
                    if (attrezzatura && quantita) {
                        ...
                        const differenzaFormula = `(${marrubiuCell}+${mairanoCell}+${altroCell})-B${wsData.length + 1}`;
